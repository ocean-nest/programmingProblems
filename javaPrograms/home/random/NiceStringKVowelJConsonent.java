...
public class NiceStringKVowelJConsonent {
    public static void main(String[] args) {
        String s = "earthproblem";
        String result = niceStringKVowelJConsonent(s, 3,3);
        System.out.println(result);

    }

    public static String niceStringKVowelJConsonent(String s, int vowelNeeded, int consonantNeeded ) {
        ...
        for(int right=0; right<s.length(); right++) {
            ...
            if(vowCount>=vowelNeeded && conCount>=consonantNeeded) {
